    ...
    try {
      ...
      if (checkError) {
        ...
        if (checkError.code === "PGRST116" || checkError.code === "42P01") {
          setError(
            "Marketplace table not found. Please set up the database schema."
          );
          return;
        }
      }
      ...
      if (insertError) {
        ...
        if (insertError.code === "42P01") {
          setError(
            "Database table not found. Please set up the marketplace_listings table."
          );
          ...
          setError("This project is already listed in the marketplace.");
        } else if (insertError.code === "22P02") {
          setError("Invalid data format. Please check your input values.");
        } else if (insertError.code === "23503") {
          setError("Invalid project reference. Please select a valid project.");
        } else {
          setError(
            insertError.message || "Failed to create listing. Please try again."
          );
        }
        ...
        if (projectError) {
          ...
          // Don't show error to user, listing is still created
        }
        ...
        setError("Failed to create listing. No data returned.");
      }
    } catch (err) {
